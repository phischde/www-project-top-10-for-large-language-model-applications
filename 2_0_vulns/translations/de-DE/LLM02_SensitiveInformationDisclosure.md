...
Implementieren Sie eine Datenbereinigung, um sicherzustellen, dass keine Benutzerdaten in das Trainingsmodell gelangen. Bereinigen oder maskieren Sie sensible Inhalte, bevor diese im Training verwendet werden.
...
Beschränken Sie den Zugriff auf sensible Daten nach dem Prinzip der geringsten Privilegien. Gewähren Sie ausschließlich Zugriff auf Daten, die für den jeweiligen Benutzer oder Prozess erforderlich sind.
...
Schränken Sie die Möglichkeit für Benutzer ein, die ursprünglichen Einstellungen des Systems zu überschreiben oder darauf zuzugreifen, um das Risiko einer Offenlegung interner Konfigurationen zu verringern.
...
Angreife umgehen Eingabefilter, um vertrauliche Informationen zu extrahieren.
