...
#### 2. Denial of Wallet (DoW)
  Durch die Initiierung einer hohen Anzahl von Vorgängen nutzen Angreifende das Kosten-pro-Nutzung-Modell von cloudbasierten KI-Diensten aus, was zu untragbaren finanziellen Belastungen für den Anbieter führt und den finanziellen Ruin riskiert.
...
#### 3. Ratenbegrenzung
Wenden Sie Ratenbegrenzung und Benutzerkontingente an, um die Anzahl der Anfragen zu beschränken, die eine einzelne Quellentität in einem bestimmten Zeitraum stellen kann.
...
Entwerfen Sie ein System, das bei hoher Last eine sanfte Verschlechterung erfährt und dabei eine Teilfunktionalität beibehält, anstatt vollständig auszufallen.
...
Angreifende übermitteln eine große Anzahl von Anfragen an die LLM-API, was zu einem übermäßigen Verbrauch von Rechenressourcen führt und den Dienst für legitime Benutzer unzugänglich macht.
